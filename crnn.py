...
class CRNN(nn.Module):
    def __init__(self, imgH, nc, nclass, nh, leakRelu=False):
        super(CRNN, self).__init__()
        assert imgH % 16 == 0, 'imgH has to be a multipe of 16'
        ...
        convRelu(2, True)
        convRelu(3)
        cnn.add_module('pooling{0}'.format(2), nn.MaxPool2d((2, 2), (2, 1), (0, 1)))  # 512*4*16
        convRelu(4, True)
        convRelu(5)
